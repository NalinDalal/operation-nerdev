...
export default function ProposalsPage() {
  ...
  return (
    <PageWrapper title="Proposal Generator" description="Create professional project proposals" active="proposals">
      <div className="flex justify-end gap-2 mb-6">
        <Button variant={currency === "INR" ? "default" : "outline"} onClick={() => handleCurrencyChange("INR")} className="gap-2">
          <DollarSign className="w-4 h-4" /> INR
        </Button>
        <Button variant={currency === "USD" ? "default" : "outline"} onClick={() => handleCurrencyChange("USD")} className="gap-2">
