...
import { ArrowRight, Download, FileText, DollarSign, Check, X } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Create professional project proposals</p>
          </div>
          <div className="flex gap-2">
            <Button
              ...
              className="gap-2"
            >
              <DollarSign className="w-4 h-4" /> INR
            </Button>
            <Button
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="Country (for international)"
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="You need a solution that helps..."
                  className="w-full min-h-[80px] px-3 py-2 border border-input rounded-md bg-background text-sm resize-y"
                />
              </div>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder={`${currencySymbol}30000`}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    value={formData.milestone2Amount}
                    onChange={handleInputChange}
                    placeholder={`${currencySymbol}40000`}
                  />
                </div>
                <div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Source code ownership&#10;2 rounds of revisions"
                  className="w-full min-h-[80px] px-3 py-2 border border-input rounded-md bg-background text-sm resize-y"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  placeholder="Third-party licenses&#10;Ongoing marketing"
                  className="w-full min-h-[80px] px-3 py-2 border border-input rounded-md bg-background text-sm resize-y"
                />
              </div>
            </CardContent>
