...
import { ArrowRight, Download, FileText, DollarSign } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Generate freelance development contracts</p>
          </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="1. Website with 5 pages&#10;2. Contact form with email&#10;3. Admin dashboard"
                  className="w-full min-h-[120px] px-3 py-2 border border-input rounded-md bg-background text-sm resize-y"
                />
              </div>
            </CardContent>
          </Card>
