...
export default function ContractsPage() {
    ...
    return (
        <SidebarLayout title="Contracts">
            <div className="flex gap-2 mb-6">
                <Button
                    variant={currency === "INR" ? "primary" : "secondary"}
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="fv-panel">
                    <h2 className="fv-head">Provider Details</h2>
                ...
                <div className="fv-panel">
                    <h2 className="fv-head">Client Details</h2>
                    <div className="space-y-4">
                        <div>
                ...
                <div className="md:col-span-2 fv-panel">
                    <h2 className="fv-head">Project Details</h2>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[120px] px-3 py-2 border border-[var(--border)] rounded-lg bg-[var(--card)] text-sm resize-y"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="md:col-span-2 fv-panel">
                    <h2 className="fv-head">Payment Details</h2>
