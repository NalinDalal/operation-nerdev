...
import { Link2, Copy, FileSignature, Send, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">E-Signature Links</h1>
          <p className="text-gray-600 mt-1">Generate signing links to send to clients</p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Contract - Project Name"
                />
              </div>
              <div>
